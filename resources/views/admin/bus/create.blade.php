...
@section('page_title', 'Tambah Data Bus')
            ...
            <form action="{{ route('admin.bus.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_bus') is-invalid @enderror" id="nama_bus" name="nama_bus" value="{{ old('nama_bus') }}" required>
                        @error('nama_bus')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jenis_bus') is-invalid @enderror" id="jenis_bus" name="jenis_bus" value="{{ old('jenis_bus') }}" required>
                        @error('jenis_bus')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('jumlah_kursi') is-invalid @enderror" id="jumlah_kursi" name="jumlah_kursi" value="{{ old('jumlah_kursi') }}" min="1">
                        @error('jumlah_kursi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
